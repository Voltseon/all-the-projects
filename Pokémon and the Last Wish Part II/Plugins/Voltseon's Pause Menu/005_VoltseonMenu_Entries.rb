...
class MenuEntryBag < MenuEntry
  ...
  def selectable?; return ($game_switches[61] && !pbInBugContest?); end
end
#-------------------------------------------------------------------------------
...
class MenuEntryTrainer < MenuEntry
  ...
  def selectable?; return $game_switches[61]; end
end
#-------------------------------------------------------------------------------
...
class MenuEntrySave < MenuEntry
  ...
  def selectable?
    return ($game_switches[61] && !pbInBugContest? && $game_system && !$game_system.save_disabled && !pbInSafari?)
  end
end
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
# Entry for BerryPots Screen
#-------------------------------------------------------------------------------
class MenuEntryBerryPots < MenuEntry
  def initialize
    @icon = "menuBerryPots"
    @name = "Berry Pots"
  end
  ...
  def selectable?; return vHI("BerryPots"); end
end