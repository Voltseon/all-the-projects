...
def pbGetThemeName(theme)
  ...
  when 2 then return _INTL("Bulb Theme")
  when 3 then return _INTL("Torch Theme")
  when 4 then return _INTL("Dile Theme")
  when 5 then return _INTL("Wishmaker Theme")
  when 6 then return _INTL("Heliotrope Theme")
  when 7 then return _INTL("Impression Theme")
  when 8 then return _INTL("Wiki Theme")
  when 9 then return _INTL("Badge Theme")
  when 10 then return _INTL("Berry Theme")
  when 11 then return _INTL("Device Theme")
  when 12 then return _INTL("Time Theme")
  when 13 then return _INTL("Virus Theme")
