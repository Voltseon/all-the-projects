...
MENU_ENTRIES = [
  ...
  "MenuEntryPokeSearch", "MenuEntryTrainer", "MenuEntryMap", "MenuEntryExitBugContest",
  "MenuEntryExitSafari", "MenuEntrySave", "MenuEntryDebug", "MenuEntryOptions",
  "MenuEntryEncounterList", "MenuEntryQuests", "MenuEntryBerryPots", "MenuEntryQuit"
]

# An array of aLL the Menu Component Classes from 004_VoltseonMenu_Components
# that need to be loaded
MENU_COMPONENTS = [
  "SafariHud", "BugContestHud", "PokemonPartyHud", "DateAndTimeHud", "NewQuestHud", "BerriesReadyHud"
]
...
MENU_TEXTCOLOR = [Color.new(248,248,248)] * 14
MENU_TEXTOUTLINE = [
            Color.new(64,64,64),
            Color.new(64,64,64),
            Color.new(68,96,0),
            ...
            Color.new(19,40,22),
            Color.new(145,75,74),
            Color.new(70,132,160),
            Color.new(196,86,177),
            Color.new(40,7,20)
          ]
LOCATION_TEXTCOLOR = [Color.new(248,248,248)] * 14
