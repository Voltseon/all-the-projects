...
class QuestList_Scene
  ...
  def pbStartScene
    ...
    pbDrawTextPositions(@sprites["overlay1"].bitmap,[
      [_INTL("{1} tasks", @quests_text[@current_quest]),18,-2,0,Color.new(248,248,248),Color.new(51,51,51),true]
    ])
  ...
  def drawQuestDesc(quest)
    ...
    pbDrawTextPositions(@sprites["overlay2"].bitmap,[
      ["#{questName}",18,-2,0,Color.new(248,248,248),Color.new(51,51,51),true]
    ])
    # Quest description
