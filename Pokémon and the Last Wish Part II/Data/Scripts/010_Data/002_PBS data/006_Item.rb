module GameData
  class Item
    ...
    def is_outfit?;          return @type == 13; end

    def is_important?
      return true if is_key_item? || is_HM? || is_TM? || is_outfit?
      return false
    end
