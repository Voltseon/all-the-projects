...
def pbStartOver(gameover=false)
  ...
  if $PokemonGlobal.pokecenterMapId && $PokemonGlobal.pokecenterMapId>=0
    if gameover
      pbMessage(_INTL("<c3=F8F8F8,484848>\\w[]\\wm\\l[3]After the unfortunate defeat, you scurry back to a Pokémon Center.</c3>"))
    else
      pbMessage(_INTL("<c3=F8F8F8,484848>\\w[]\\wm\\l[3]You scurry back to a Pokémon Center, protecting your exhausted Pokémon from any further harm...</c3>"))
    end
    pbCancelVehicles
    ...
    if gameover
      pbMessage(_INTL("<c3=F8F8F8,484848>\\w[]\\wm\\l[3]After the unfortunate defeat, you scurry back home.</c3>"))
    else
      pbMessage(_INTL("<c3=F8F8F8,484848>\\w[]\\wm\\l[3]You scurry back home, protecting your exhausted Pokémon from any further harm...</c3>"))
    end
    if homedata
      pbCancelVehicles
      pbRemoveDependencies
