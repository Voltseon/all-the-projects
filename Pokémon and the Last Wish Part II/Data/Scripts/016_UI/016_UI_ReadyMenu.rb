...
#===============================================================================
def pbUseKeyItem
  moves = [:STOMP, :DEFOG, :DIG, :DIVE, :FLASH, :PSYCHOMATTER, :HEADBUTT, :BOUNCE,
           :ROCKSMASH, :SECRETPOWER, :STRENGTH, :AQUAJET, :SWEETSCENT, :TELEPORT,
           :WATERFALL, :WHIRLPOOL, :EXTREMESPEED]
  real_moves = []
  moves.each do |move|
