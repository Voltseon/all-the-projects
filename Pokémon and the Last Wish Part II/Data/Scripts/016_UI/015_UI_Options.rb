...
class PokemonSystem
  ...
  def initialize
    ...
    @bgmvolume   = 70   # Volume of background music and ME
    @sevolume    = 70   # Volume of sound effects
...
class Window_PokemonOption < Window_DrawableCommand
  ...
  def initialize(options,x,y,width,height)
    ...
    @nameShadowColor = Color.new(0,0,0)
    @selBaseColor    = Color.new(0,0,0)
    @selShadowColor  = Color.new(0,0,0)
    @optvalues = []
    update_colors
  ...
  def update_colors
    @testwindow = Window_AdvancedTextPokemon.new("")
    if isDarkWindowskin(@testwindow.windowskin)
      @nameBaseColor   = Color.new(248,176,80)
      @nameShadowColor = Color.new(192,120,0)
      @selBaseColor    = Color.new(248,136,128)
      @selShadowColor  = Color.new(248,48,24)
    else
