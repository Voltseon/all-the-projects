  ...
  def pbStartScene(helptext,minlength,maxlength,initialText,subject=0,pokemon=nil)
    ...
    when 2   # Pokémon
      if pokemon
        ...
        textpos=[]
        if pokemon.male?
          textpos.push([_INTL("♂"),0,-6,false,Color.new(0,128,248),Color.new(72,72,72)])
        elsif pokemon.female?
          textpos.push([_INTL("♀"),0,-6,false,Color.new(248,24,24),Color.new(72,72,72)])
        end
...
class PokemonEntryScene2
  ...
  def pbStartScene(helptext,minlength,maxlength,initialText,subject=0,pokemon=nil)
    ...
    underline_bitmap.fill_rect(2, 2, 22, 4, Color.new(72,72,72))
  ...
  def pbDoUpdateOverlay
    ...
    textPositions = [
       [@helptext, 160, 6, false, Color.new(248,248,248), Color.new(72,72,72)]
    ]
    chars = @helper.textChars
    x = 166
    for ch in chars
      textPositions.push([ch, x, 42, false, Color.new(248,248,248), Color.new(72,72,72)])
      x += 24
    end
