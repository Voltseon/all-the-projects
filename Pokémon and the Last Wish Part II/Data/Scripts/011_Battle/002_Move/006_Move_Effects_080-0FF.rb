  ...
  def initialize(battle,move)
    ...
    @flingPowers = {
      ...
      100 => [:HARDSTONE,:RAREBONE,
       ...
       90 => [:DEEPSEATOOTH,:GRIPCLAW,:THICKCLUB,:POLISHER,
              # Plates
       ...
       30 => [:ABSORBBULB,:ADRENALINEORB,:AMULETCOIN,:BINDINGBAND,:BLACKBELT,
              ...
              :SOULDEW,:SPELLTAG,:TOXICORB,:TWISTEDSPOON,:UPGRADE,:WAXCANDLE,:SPIRITCANDLE,
              :ANCIENTNECKLACE,
              # Healing items
       ...
       10 => [:AIRBALLOON,:BIGROOT,:BRIGHTPOWDER,:CHOICEBAND,:CHOICESCARF,
              ...
              # Special
              :MUDPLATING,:METALBARB,:MANGANESE,:ACTIVATEDCHARCOAL,:MAGNETICRING
             ]
    }
  end
