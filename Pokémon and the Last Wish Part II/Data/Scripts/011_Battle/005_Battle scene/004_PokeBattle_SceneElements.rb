...
class PokemonDataBox < SpriteWrapper
  ...
  MALE_BASE_COLOR         = Color.new(119,191,255)
  MALE_SHADOW_COLOR       = NAME_SHADOW_COLOR
  FEMALE_BASE_COLOR       = Color.new(255,183,203)
  ...
  def refresh
    ...
    # Draw shiny icon
    if @battler.shiny?
      shinyX = (@battler.opposes?(0)) ? 206 : 14  # Foe's/player's
...
class AbilitySplashBar < SpriteWrapper
  ...
  TEXT_SHADOW_COLOR = Color.new(72,72,72)
