...
# Symbol class extensions
class Symbol
  # Converts to bits
  def to_b
    return self.to_s.to_b
  end
  ...
  # Returns whether or not the symbol is empty
  def empty?
    return (self.to_s.size == 0)
  end
  
  # Returns whether or not the symbol is numeric
  def numeric?
    return self.to_s.numeric?
  end
end
