...
#-------------------------------------------------------------------------------
# Background options
BACKGROUND_TINT = Color.new(-40,-40,-40,130) # Tone (Red, Green, Blue, Grey) applied to the background/map.

SHOW_MENU_NAMES = false # Whether or not the Menu Names show on screen (true = show names)
