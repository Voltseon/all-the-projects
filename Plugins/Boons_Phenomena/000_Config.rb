...
module PhenomenonConfig
  ...
  Timer = 720 # How many frames to wait before phenomenon disappears
  Switch = 60 # Switch that when ON enables phenomena
  BattleMusic = "FRLG 18 Battle (VS Wild Pokemon)" # Custom music to play during Phenomenon
  Pokemon = {
    ...
    # Set to -1 to disable
    :ivs => 8, # 2 perfect IVs
    :eggMoves => 5, # A random egg move
    :hiddenAbility => 3, # Generated with hidden ability
  }
  Types = {
 ...
 # 69 => {
  ...
  Items = {
    ...
    :commonCave => [:FIREGEM, :WATERGEM, :ICEGEM, :ELECTRICGEM, :GRASSGEM, :FIGHTINGGEM,
                    ...
                    :BLUESHARD, :YELLOWSHARD, :GREENSHARD, :SHADOWGEM],
    # 10% chance
