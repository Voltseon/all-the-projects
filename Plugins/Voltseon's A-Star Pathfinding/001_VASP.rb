...
def move_to_location(event = nil, desired_x = 0, desired_y = 0, wait_for_completion = false, a = false)
...
def move_to_event(event_a = nil, event_b = nil, wait_for_completion = false, a = false)
  # Get the event from the specified event ID if specified
