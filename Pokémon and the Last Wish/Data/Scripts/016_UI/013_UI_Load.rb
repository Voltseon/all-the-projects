  ...
  def refresh
    ...
    if @refreshBitmap
      ...
      if @isContinue
        ...
        textpos.push([_INTL("Themes:"),16*2,53*2,0,TEXTCOLOR,TEXTSHADOWCOLOR])
        textpos.push([_INTL("{1}",$PokemonSystem.unlocked_menu_themes),103*2,53*2,1,TEXTCOLOR,TEXTSHADOWCOLOR])
