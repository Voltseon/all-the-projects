...
WILD_ITEMS = [
  :POTION, :SUPERPOTION, :ETHER, :ELIXIR, :EMONBERRY, :ORANBERRY, :SITRUSBERRY, :LUMBERRY,
  :LEPPABERRY, :CHESTOBERRY, :CHERIBERRY, :ASPEARBERRY, :RAWSTBERRY, :PECHABERRY,
  :POKEBALL, :GREATBALL, :RARECANDY, :PEARL, :TINYMUSHROOM, :BIGMUSHROOM,
  :LEFTOVERS, :BERRYJUICE, :STARDUST, :EVERSTONE, :FIRESTONE, :WATERSTONE,
  :LEAFSTONE, :THUNDERSTONE, :SHINYSTONE, :DAWNSTONE, :DUSKSTONE,
  :HONEY, :PPUP, :CARBOS, :ZINC, :PROTEIN, :IRON, :HPUP, :CALCIUM,
  :IRONBALL, :REVIVE, :REPEL, :SUPERREPEL, :PRETTYWING, :CLEANSETAG,
  :AWAKENING, :ANTIDOTE, :BURNHEAL, :PARALYZEHEAL, :ICEHEAL, :PETRIFYHEAL
]
