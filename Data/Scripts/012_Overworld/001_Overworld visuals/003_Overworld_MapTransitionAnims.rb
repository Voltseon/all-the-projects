...
def pbStartOver(gameover=false)
  ...
  if $PokemonGlobal.pokecenterMapId && $PokemonGlobal.pokecenterMapId>=0
    if gameover
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]After the unfortunate defeat, you scurry back to a PTA Center."))
    else
      pbMessage(_INTL("\\w[]\\wm\\c[8]\\l[3]You scurry back to a PTA Center, protecting your exhausted Pokémon from any further harm..."))
    end
    pbCancelVehicles
