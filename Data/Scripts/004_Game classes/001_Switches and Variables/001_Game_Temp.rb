...
class Game_Temp
  ...
  attr_accessor :panorama_scroll_x
  attr_accessor :panorama_scroll_y
  attr_accessor :continuous_shake
  attr_accessor :smashables
  # Alarm
  attr_accessor :alarms
  attr_accessor :alarm_on
  attr_accessor :alarm_counter
  # Minimap
  ...
  def panorama_scroll_x=(value)
    value = 0 if !$game_switches[75]
    @panorama_scroll_x = value
    $game_map.need_refresh = true
  end

  def panorama_scroll_y=(value)
    value = 0 if !$game_switches[75]
    @panorama_scroll_y = value
    $game_map.need_refresh = true
  end
end
