  ...
  class PlayerMetadata
    ...
    def self.editor_properties
      return [
        ...
        ["MountCharset",    CharacterProperty,       _INTL("Charset used while the player is mounting. Uses RunCharset if undefined.")],
    ...
    def initialize(hash)
      ...
      @mount_charset    = hash[:mount_charset]
    ...
    def mount_charset
      return @mount_charset || cycle_charset
    end
    ...
    def property_from_string(str)
      ...
      when "MountCharset"  then return @mount_charset
