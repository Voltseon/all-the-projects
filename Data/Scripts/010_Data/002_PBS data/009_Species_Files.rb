module GameData
  class Species
    def self.check_graphic_file(path, species, form = 0, gender = 0, shiny = false, shadow = false, subfolder = "", supershiny = false)
      ...
      factors = []
      factors.push([4, sprintf("%s shiny/", subfolder), try_subfolder]) if shiny && !supershiny
      factors.push([4, sprintf("%s super shiny/", subfolder), try_subfolder]) if supershiny
    ...
    def self.check_egg_graphic_file(path, species, form, suffix = "")
      ...
      type_try = species_data.types[0]
      type_try = species_data.types[1] if type_try == :NORMAL && species_data.types.length > 1
      if form > 0
      ...
      return ret if ret
      return pbResolveBitmap(sprintf("%s%s%s", path, type_try, suffix)) 
    end

    def self.front_sprite_filename(species, form = 0, gender = 0, shiny = false, shadow = false, supershiny = false)
      return self.check_graphic_file("Graphics/Pokemon/", species, form, gender, shiny, shadow, "Front", supershiny)
    end

    def self.back_sprite_filename(species, form = 0, gender = 0, shiny = false, shadow = false, supershiny = false)
      return self.check_graphic_file("Graphics/Pokemon/", species, form, gender, shiny, shadow, "Back", supershiny)
    end
    ...
    def self.sprite_filename(species, form = 0, gender = 0, shiny = false, shadow = false, back = false, egg = false, supershiny = false)
      return self.egg_sprite_filename(species, form) if egg
      return self.back_sprite_filename(species, form, gender, shiny, shadow, supershiny) if back
      return self.front_sprite_filename(species, form, gender, shiny, shadow, supershiny)
    end

    def self.front_sprite_bitmap(species, form = 0, gender = 0, shiny = false, shadow = false, supershiny = false)
      filename = self.front_sprite_filename(species, form, gender, shiny, shadow, supershiny)
      return (filename) ? AnimatedBitmap.new(filename) : nil
    end

    def self.back_sprite_bitmap(species, form = 0, gender = 0, shiny = false, shadow = false, supershiny = false)
      filename = self.back_sprite_filename(species, form, gender, shiny, shadow, supershiny)
      return (filename) ? AnimatedBitmap.new(filename) : nil
    end
    ...
    def self.sprite_bitmap(species, form = 0, gender = 0, shiny = false, shadow = false, back = false, egg = false, supershiny = false)
      return self.egg_sprite_bitmap(species, form) if egg
      return self.back_sprite_bitmap(species, form, gender, shiny, shadow, supershiny) if back
      return self.front_sprite_bitmap(species, form, gender, shiny, shadow, supershiny)
    end
    ...
    def self.sprite_bitmap_from_pokemon(pkmn, back = false, species = nil)
      ...
      if back
        ret = self.back_sprite_bitmap(species, pkmn.form, pkmn.gender, pkmn.shiny?, pkmn.shadowPokemon?, pkmn.super_shiny?)
      else
        ret = self.front_sprite_bitmap(species, pkmn.form, pkmn.gender, pkmn.shiny?, pkmn.shadowPokemon?, pkmn.super_shiny?)
      end
    ...
    def self.icon_filename(species, form = 0, gender = 0, shiny = false, shadow = false, egg = false, supershiny = false)
      return self.egg_icon_filename(species, form) if egg
      return self.check_graphic_file("Graphics/Pokemon/", species, form, gender, shiny, shadow, "Icons", supershiny)
    end
    ...
    def self.icon_bitmap(species, form = 0, gender = 0, shiny = false, shadow = false, egg = false, supershiny = false)
      return self.egg_icon_bitmap(species, form) if egg
      filename = self.icon_filename(species, form, gender, shiny, shadow, supershiny)
      return (filename) ? AnimatedBitmap.new(filename).deanimate : nil
    end

    def self.icon_bitmap_from_pokemon(pkmn)
      return self.icon_bitmap(pkmn.species, pkmn.form, pkmn.gender, pkmn.shiny?, pkmn.shadowPokemon?, pkmn.egg?, pkmn.super_shiny?)
    end
