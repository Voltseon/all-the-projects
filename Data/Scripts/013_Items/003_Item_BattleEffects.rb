...
ItemHandlers::CanUseInBattle.addIf(:poke_balls,
  proc { |item| GameData::Item.get(item).is_poke_ball? },   # Poké Balls
  proc { |item, pokemon, battler, move, firstAction, battle, scene, showMessages|
    ...
    if battle.pbOpposingBattlerCount > 1 && !(GameData::Item.get(item).is_snag_ball? && battle.trainerBattle?) && !battler.shadowPokemon?
...
ItemHandlers::CanUseInBattle.copy(:POTION,
   ...
   :ENERGYROOT)
ItemHandlers::CanUseInBattle.copy(:POTION, :RAGECANDYBAR) if Settings.pbGetGeneration < 7
...
ItemHandlers::CanUseInBattle.copy(:FULLHEAL, :RAGECANDYBAR) if Settings.pbGetGeneration >= 7
...
ItemHandlers::BattleUseOnPokemon.copy(:POTION, :RAGECANDYBAR) if Settings.pbGetGeneration < 7

ItemHandlers::BattleUseOnPokemon.add(:SUPERPOTION, proc { |item, pokemon, battler, choices, scene|
  pbBattleHPItem(pokemon, battler, (Settings.pbGetGeneration >= 7) ? 60 : 50, scene)
})

ItemHandlers::BattleUseOnPokemon.add(:HYPERPOTION, proc { |item, pokemon, battler, choices, scene|
  pbBattleHPItem(pokemon, battler, (Settings.pbGetGeneration >= 7) ? 150 : 200, scene)
})
...
ItemHandlers::BattleUseOnPokemon.add(:FRESHWATER, proc { |item, pokemon, battler, choices, scene|
  pbBattleHPItem(pokemon, battler, (Settings.pbGetGeneration >= 7) ? 30 : 50, scene)
})

ItemHandlers::BattleUseOnPokemon.add(:SODAPOP, proc { |item, pokemon, battler, choices, scene|
  pbBattleHPItem(pokemon, battler, (Settings.pbGetGeneration >= 7) ? 50 : 60, scene)
})

ItemHandlers::BattleUseOnPokemon.add(:LEMONADE, proc { |item, pokemon, battler, choices, scene|
  pbBattleHPItem(pokemon, battler, (Settings.pbGetGeneration >= 7) ? 70 : 80, scene)
})
...
ItemHandlers::BattleUseOnPokemon.copy(:FULLHEAL, :RAGECANDYBAR) if Settings.pbGetGeneration >= 7
...
ItemHandlers::BattleUseOnPokemon.add(:REVIVE, proc { |item, pokemon, battler, choices, scene|
  ...
  pokemon.hp = 1 if ($player.onehp || $player.nohealing) && battler.pbOwnedByPlayer?
  pokemon.heal_status
  scene.pbRefresh
...
ItemHandlers::BattleUseOnPokemon.add(:ENERGYPOWDER, proc { |item, pokemon, battler, choices, scene|
  if pbBattleHPItem(pokemon, battler, (Settings.pbGetGeneration >= 7) ? 60 : 50, scene)
    pokemon.changeHappiness("powder")
  end
})

ItemHandlers::BattleUseOnPokemon.add(:ENERGYROOT, proc { |item, pokemon, battler, choices, scene|
  if pbBattleHPItem(pokemon, battler, (Settings.pbGetGeneration >= 7) ? 120 : 200, scene)
...
ItemHandlers::BattleUseOnBattler.add(:XATTACK, proc { |item, battler, scene|
  battler.pbRaiseStatStage(:ATTACK, (Settings.pbGetGeneration >= 7) ? 2 : 1, battler)
  battler.pokemon.changeHappiness("battleitem")
})
...
ItemHandlers::BattleUseOnBattler.add(:XDEFENSE, proc { |item, battler, scene|
  battler.pbRaiseStatStage(:DEFENSE, (Settings.pbGetGeneration >= 7) ? 2 : 1, battler)
  battler.pokemon.changeHappiness("battleitem")
})
...
ItemHandlers::BattleUseOnBattler.add(:XSPATK, proc { |item, battler, scene|
  battler.pbRaiseStatStage(:SPECIAL_ATTACK, (Settings.pbGetGeneration >= 7) ? 2 : 1, battler)
  battler.pokemon.changeHappiness("battleitem")
})
...
ItemHandlers::BattleUseOnBattler.add(:XSPDEF, proc { |item, battler, scene|
  battler.pbRaiseStatStage(:SPECIAL_DEFENSE, (Settings.pbGetGeneration >= 7) ? 2 : 1, battler)
  battler.pokemon.changeHappiness("battleitem")
})
...
ItemHandlers::BattleUseOnBattler.add(:XSPEED, proc { |item, battler, scene|
  battler.pbRaiseStatStage(:SPEED, (Settings.pbGetGeneration >= 7) ? 2 : 1, battler)
  battler.pokemon.changeHappiness("battleitem")
})
...
ItemHandlers::BattleUseOnBattler.add(:XACCURACY, proc { |item, battler, scene|
  battler.pbRaiseStatStage(:ACCURACY, (Settings.pbGetGeneration >= 7) ? 2 : 1, battler)
  battler.pokemon.changeHappiness("battleitem")
})
