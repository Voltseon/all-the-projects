...
MenuHandlers.add(:debug_menu, :set_money, {
  ...
  "effect"      => proc {
    ...
    pbMessage(_INTL("You now have ${1}.", $player.money.decrypt.to_s_formatted))
  }
})
...
MenuHandlers.add(:debug_menu, :toggle_pokegear, {
  "name"        => _INTL("Toggle P★DA"),
  "parent"      => :player_menu,
  "description" => _INTL("Toggle possession of the P★DA."),
  "effect"      => proc {
    $player.has_pokegear = !$player.has_pokegear
    pbMessage(_INTL("Gave P★DA.")) if $player.has_pokegear
    pbMessage(_INTL("Lost P★DA.")) if !$player.has_pokegear
  }
})

MenuHandlers.add(:debug_menu, :toggle_pdaplus, {
  "name"        => _INTL("Toggle P★DA+"),
  "parent"      => :player_menu,
  "description" => _INTL("Toggle possession of the P★DA+."),
  "effect"      => proc {
    $player.has_pdaplus = !$player.has_pdaplus
    pbMessage(_INTL("Gave P★DA+.")) if $player.has_pdaplus
    pbMessage(_INTL("Lost P★DA+.")) if !$player.has_pdaplus
  }
})
