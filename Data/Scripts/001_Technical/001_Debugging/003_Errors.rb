...
def pbPrintException(e)
  ...
  if e.class == MKXPError
    message = ""
    message += "Error looking for updates. How to fix:\r\n\r\n"
    message += "Open the \'mkxp.json\' file in game folder and change \'useHTTPLite\' to false."
  end
  # show last 10/25 lines of backtrace
  if !e.is_a?(EventScriptError) && e.class != MKXPError
    message += "\r\n\r\nBacktrace:\r\n"
    backtrace_text = ""
    if e.backtrace
