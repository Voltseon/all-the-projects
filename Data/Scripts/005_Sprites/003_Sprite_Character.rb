...
class Sprite_Character < RPG::Sprite
  ...
  def update
    ...
    if (@character.is_a?(Game_Player) || @character.is_a?(Game_Event)) && $PokemonGlobal.diving
      self.tone.set(-120, -40, 0, 0)
    end
    ...
    self.z          = 99999 if @character.is_a?(Game_Event) && @character.name[/regulartone/i]
