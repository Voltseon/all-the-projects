module MessageConfig
  ...
  LIGHT_TEXT_SHADOW_COLOR = Color.new(56,23,4)
  DARK_TEXT_MAIN_COLOR    = Color.new(86, 34, 6)
  DARK_TEXT_SHADOW_COLOR  = Color.new(56,23,4)
  FONT_NAME               = "Power Ethos"
  FONT_SIZE               = 24
  SMALL_FONT_NAME         = "Power Ethos"
  SMALL_FONT_SIZE         = 24
  NARROW_FONT_NAME        = "Power Ethos"
  NARROW_FONT_SIZE        = 24
...
def getSkinColor(windowskin,color,isDarkSkin)
  if !windowskin || windowskin.disposed? ||
    ...
    textcolors = [
      "2F2831","45A5EF",   # 1  Blue
       "5A1906","EF4F4C",   # 2  Red
       "413410","7BCE5A",   # 3  Green
       "3C3C2B","52D6DD",   # 4  Cyan
       "561E25","E560D8",   # 5  Magenta
       "562206","F7D54C",   # 6  Yellow
       "4D3122","AAAAAF",   # 7  Grey
       "4C2F20","F8F8F8",   # 8  White
       "4A1F2E","8D75DD",   # 9  Purple
       "562206","F79651",   # 10 Orange
       colorToRgb32(MessageConfig::DARK_TEXT_SHADOW_COLOR),
          colorToRgb32(MessageConfig::DARK_TEXT_MAIN_COLOR),   # 11 Dark default
