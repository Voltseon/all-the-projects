module MessageConfig
  ...
  DARK_TEXT_MAIN_COLOR    = Color.new(248, 248, 248)
  DARK_TEXT_SHADOW_COLOR  = Color.new(57, 198, 249)
  FONT_NAME               = "DPComic"
  FONT_SIZE               = 36
  FONT_Y_OFFSET           = 4
  SMALL_FONT_NAME         = "DPComic"
  SMALL_FONT_SIZE         = 18
  SMALL_FONT_Y_OFFSET     = 16
  NARROW_FONT_NAME        = "DPComic"
  NARROW_FONT_SIZE        = 18
  NARROW_FONT_Y_OFFSET    = 16
...
def getSkinColor(windowskin, color, isDarkSkin)
  if !windowskin || windowskin.disposed? ||
    ...
    textcolors = [
      "F8F8F8", "7F88FF",   # 1  Blue
      "F8F8F8", "FF7FD3",   # 2  Pink
      "F8F8F8", "40E556",   # 3  Green
      "F8F8F8", "FFAB7F",   # 4  Orange
      "F8F8F8", "CB7FFF",   # 5  Purple
      colorToRgb32(MessageConfig::DARK_TEXT_MAIN_COLOR),
      colorToRgb32(MessageConfig::DARK_TEXT_SHADOW_COLOR),   # 6 Dark default
      colorToRgb32(MessageConfig::LIGHT_TEXT_MAIN_COLOR),
      colorToRgb32(MessageConfig::LIGHT_TEXT_SHADOW_COLOR)   # 7 Light default
    ]
...
def pbFadeOutIn(z = 99999, nofadeout = false)
  ...
  viewport.z = z
  numFrames = (Graphics.frame_rate * 0.2).floor
