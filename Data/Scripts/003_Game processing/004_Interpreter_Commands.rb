...
#    when 3, 4, 5   # item, actor, enemy
    ...
    when 7   # other
      ...
      when 2 then value = $player.money.decrypt                        # gold
#      when 3   # steps
  ...
  def command_125
    ...
    $player.money = $player.money.decrypt + value
    return true
  end
  ...
  def command_201
    ...
    this_event = get_self
    this_warp = $player.warps[[this_event.map_id, this_event.id]]
    @parameters = [@parameters[0]] + this_warp.to_params unless this_warp.nil?
