...
class PokemonSave_Scene
  def pbStartScreen
    ...
    textColor = ["44A2EA,2F2831","EB4E4A,5A1906","44A2EA,2F2831"][$Trainer.gender]
    locationColor = "7BCE5A,413410"   # green
    ...
    if $Trainer.has_pokedex
      loctext+=_INTL("Book<r><c3={1}>{2}/{3}</c3>",textColor,$Trainer.pokedex.owned_count,$Trainer.pokedex.seen_count)
    end
