...
class PokemonEntryScene
  ...
  def pbStartScene(helptext,minlength,maxlength,initialText,subject=0,pokemon=nil)
    ...
    @sprites["helpwindow"].shadowColor=Color.new(56,23,4)
    ...
    when 2   # Pokémon
      if pokemon
        ...
        textpos=[]
        if pokemon.male?
          textpos.push([_INTL("♂"),0,-6,false,Color.new(0,128,248),Color.new(56,23,4)])
        elsif pokemon.female?
          textpos.push([_INTL("♀"),0,-6,false,Color.new(248,24,24),Color.new(56,23,4)])
        end
...
class PokemonEntryScene2
  ...
  def pbStartScene(helptext,minlength,maxlength,initialText,subject=0,pokemon=nil)
      ...
      for y in 0...COLUMNS
        for x in 0...ROWS
          ...
          textPos.push([@@Characters[i][0][pos], 44 + x * 32, 12 + y * 38, 2,
            Color.new(248,248,248), Color.new(56,23,4)])
        end
      end
    ...
    underline_bitmap.fill_rect(2, 2, 22, 4, Color.new(56,23,4))
    underline_bitmap.fill_rect(0, 0, 22, 4, Color.new(248,248,248))
  ...
  def pbDoUpdateOverlay
    ...
    textPositions = [
       [@helptext, 160, 6, false, Color.new(248,248,248), Color.new(56,23,4)]
    ]
    chars = @helper.textChars
    x = 166
    for ch in chars
      textPositions.push([ch, x, 42, false, Color.new(248,248,248), Color.new(56,23,4)])
      x += 24
    end
