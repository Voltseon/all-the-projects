...
class PokemonTrainerCard_Scene
  ...
  def pbStartScene
    ...
    @sprites["trainer"].y -= (@sprites["trainer"].bitmap.height-164)
    @sprites["trainer"].z = 2
  ...
  def pbDrawTrainerCardFront
    ...
    starttime = _INTL("{1} {2}, {3}",
       ...
       $PokemonGlobal.startTime.year-40)
    textPositions = [
       ...
       [_INTL("The Book of Ethos"),34,154,0,baseColor,shadowColor],
    ...
    for i in 0...8
      if $Trainer.badges[i]
        imagePositions.push(["Graphics/Pictures/Trainer Card/icon_badges",x,24,i*32,0,32,32])
      end
      x += 32
    end
