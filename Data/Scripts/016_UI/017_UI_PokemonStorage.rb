  ...
  def refresh
    if @refreshBox
      ...
      pbDrawShadowText(@contents,xval,8,widthval,32,
         boxname,Color.new(248,248,248),Color.new(56,23,4))
      @refreshBox = false
    end
    yval = self.y+30+16
...
class PokemonBoxPartySprite < SpriteWrapper
  ...
  def refresh
    ...
    pbDrawTextPositions(self.bitmap,[
       [_INTL("Back"), 86, 240, 2, Color.new(248, 248, 248), Color.new(56,23,4), 1]
    ])
...
class PokemonStorageScene
  ...
  def pbSetArrow(arrow,selection)
    ...
    when -3 # Close Box
      ...
      arrow.x = (97 + 30 * (selection % PokemonBox::BOX_WIDTH)) * 2
      arrow.y = (8 + 30 * (selection / PokemonBox::BOX_WIDTH)) * 2
    end
  end
  ...
  def pbUpdateOverlay(selection,party=nil)
    ...
    buttonshadow = Color.new(56,23,4)
