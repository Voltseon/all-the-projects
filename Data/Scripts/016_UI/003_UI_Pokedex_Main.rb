...
class Window_Pokedex < Window_DrawableCommand
  def initialize(x,y,width,height,viewport)
    ...
    self.baseColor   = Color.new(51, 49, 49)
    self.shadowColor = Color.new(175, 172, 170)
    self.windowskin  = nil
  end
...
=end
  ...
  def pbRefresh
    ...
    dexname = _INTL("The Book of Ethos")
    ...
    textpos = [
       [dexname,Graphics.width/2,-6,2,base,shadow]
    ]
    ...
    if @searchResults
      ...
      textpos.push([_INTL("Sean:"),42,302,0,base,shadow])
  ...
  def pbRefreshDexSearch(params,_index)
    ...
    # Write various bits of text
    textpos = [
       [_INTL("Search Mode"),Graphics.width/2,-6,2,base,shadow],
