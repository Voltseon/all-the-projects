...
class PokemonMart_Scene
  ...
  def pbStartBuyOrSellScene(buying, stock, adapter)
    ...
    @sprites["itemtextwindow"].shadowColor = Color.new(56,23,4)
    ...
    @sprites["moneywindow"].shadowColor = Color.new(56,23,4)
  ...
  def pbChooseNumber(helptext,item,maximum)
    ...
    using(numwindow = Window_AdvancedTextPokemon.new("")) {   # Showing number of items
      ...
      using(inbagwindow = Window_AdvancedTextPokemon.new("")) {   # Showing quantity in bag
        ...
        numwindow.shadowColor = Color.new(56,23,4)
        ...
        inbagwindow.shadowColor = Color.new(56,23,4)
...
def pbPokemonMart(stock,speech=nil,cantsell=false)
  ...
  cmd = pbMessage(
     speech ? speech : _INTL("\\bWelcome to the PTA Mart! How can I help you?"),
     commands,cmdQuit+1)
  loop do
