...
class Game_Temp
  attr_accessor :evolution_screen

  def evolution_screen
    @evolution_screen = false if !@evolution_screen
    return @evolution_screen
  end

  def evolution_screen=(val)
    @evolution_screen = val
  end
end