...
class Scene_Credits
  ...
  BACKGROUNDS_LIST       = ["credits"]
  BGM                    = "RSE 252 The End"
  SCROLL_SPEED           = 45   # Pixels per second
...
Tilesets by:
Ekat<s>Vurtax
Slimshady<s>TheWildDeadHeroAlistar
Zein<s>Heartlessdragoon
Idilio<s>Aveontrainer
Shyinn<s>AnonAlpaca
Zeo<s>Aldo
War8<s>Redblueyellow
SteamyJ<s>Puggsoy
Voltseon<s>Pokémon Rejuvenation
