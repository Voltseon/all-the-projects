...
class PokemonLoadPanel < SpriteWrapper
  ...
  TEXTCOLOR             = Color.new(86, 84, 84)
  TEXTSHADOWCOLOR       = Color.new(175, 172, 170)
  ...
  def refresh
    ...
    if !self.bitmap || self.bitmap.disposed?
      self.bitmap = BitmapWrapper.new(@bgbitmap.width,242)
    ...
    if @refreshBitmap
      ...
      if @isContinue
        self.bitmap.blt(0,0,@bgbitmap.bitmap,Rect.new(0,(@selected) ? 242 : 0,@bgbitmap.width,242))
      else
        self.bitmap.blt(0,0,@bgbitmap.bitmap,Rect.new(0,242*2+((@selected) ? 46 : 0),@bgbitmap.width,46))
      end
      textpos = []
      if @isContinue
        ...
        textpos.push([_INTL("Book:"),16*2,69*2,0,TEXTCOLOR,TEXTSHADOWCOLOR])
