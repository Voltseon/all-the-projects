...
class PokeBattle_Move_096 < PokeBattle_Move
  def initialize(battle,move)
    ...
    @typeArray = {
       ...
       :ROCK     => [:WIKIBERRY,   :MAGOSTBERRY, :CHARTIBERRY, :MICLEBERRY, :EMONBERRY],
    ...
    @flingPowers = {
      ...
      100 => [:HARDSTONE,:RAREBONE,
       ...
       30 => [:ABSORBBULB,:ADRENALINEORB,:AMULETCOIN,:BINDINGBAND,:BLACKBELT,
              ...
              :SOULDEW,:SPELLTAG,:TOXICORB,:TWISTEDSPOON,:UPGRADE,:PURITYORB,
              # Healing items
              ...
              :ICEHEAL,:PETRIFYHEAL,:LAVACOOKIE,:LEMONADE,:LUMIOSEGALETTE,:MAXELIXIR,
