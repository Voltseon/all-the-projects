class Battle::Move
  ...
  CRITICAL_HIT_RATIOS = (Settings.pbGetGeneration >= 6) ? [24, 8, 2, 1] : [16, 8, 4, 3, 2]
  ...
  def display_type(battler)
    ...
    when "TypeDependsOnUserPlate", "TypeDependsOnUserMemory",
         ...
         "TypeAndPowerDependOnTerrain", "TypeDependsOnUserIncreasesSpAtk",
         "TypeDependsOnUserIncreasesAttack"
      return pbBaseType(battler)
    end
