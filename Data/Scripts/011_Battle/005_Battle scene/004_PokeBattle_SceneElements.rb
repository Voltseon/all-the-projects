...
class PokemonDataBox < SpriteWrapper
  ...
  NAME_SHADOW_COLOR       = Color.new(56,23,4)
  MALE_BASE_COLOR         = Color.new(68, 162, 234)
  MALE_SHADOW_COLOR       = Color.new(47, 40, 49)
  FEMALE_BASE_COLOR       = Color.new(239, 79, 76)
  FEMALE_SHADOW_COLOR     = Color.new(91, 26, 6)
