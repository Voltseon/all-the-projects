...
class BattlerDamageAnimation < PokeBattle_Animation
  ...
  def createProcesses
    ...
    when 3 then battler.setSE(delay, "Battle damage quad")
    when 4 then battler.setSE(delay, "Battle damage ultraweak")
    when 5 then battler.setSE(delay, "Battle damage ohko")
    end
