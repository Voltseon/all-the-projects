...
class Battle::AI
  ...
  def pbGetMoveScores
    ...
    @user.battler.eachMoveWithIndex do |orig_move, idxMove|
      ...
      if @move.function_code == "CurseTargetOrLowerUserSpd1RaiseUserAtkDef1" &&
        ...
        target_data = GameData::Target.get((Settings.pbGetGeneration >= 8) ? :RandomNearFoe : :NearFoe)
      end
  ...
  def pbPredictMoveFailureAgainstTarget
    ...
    return true if @move.move.pbDamagingMove? && Effectiveness.ineffective?(typeMod) && @field.weather != :LightOasis
    # Dark-type immunity to moves made faster by Prankster
    return true if Settings.pbGetGeneration >= 7 && @move.statusMove? &&
