...
class Battle::AI
  HP_HEAL_ITEMS = {
    :POTION       => 20,
    :SUPERPOTION  => (Settings.pbGetGeneration >= 7) ? 60 : 50,
    :HYPERPOTION  => (Settings.pbGetGeneration >= 7) ? 120 : 200,
    :MAXPOTION    => 999,
    :BERRYJUICE   => 20,
    :SWEETHEART   => 20,
    :FRESHWATER   => (Settings.pbGetGeneration >= 7) ? 30 : 50,
    :SODAPOP      => (Settings.pbGetGeneration >= 7) ? 50 : 60,
    :LEMONADE     => (Settings.pbGetGeneration >= 7) ? 70 : 80,
    :MOOMOOMILK   => 100,
    :ORANBERRY    => 10,
    :SITRUSBERRY  => 1,   # Actual amount is determined below (pkmn.totalhp / 4)
    :ENERGYPOWDER => (Settings.pbGetGeneration >= 7) ? 60 : 50,
    :ENERGYROOT   => (Settings.pbGetGeneration >= 7) ? 120 : 200
  }
  HP_HEAL_ITEMS[:RAGECANDYBAR] = 20 if Settings.pbGetGeneration < 7
  FULL_RESTORE_ITEMS = [
    :FULLRESTORE
  ]
  ...
  ALL_STATUS_CURE_ITEMS.push(:RAGECANDYBAR) if Settings.pbGetGeneration >= 7
  ONE_STAT_RAISE_ITEMS = {
    :XATTACK    => [:ATTACK, (Settings.pbGetGeneration >= 7) ? 2 : 1],
    :XATTACK2   => [:ATTACK, 2],
    :XATTACK3   => [:ATTACK, 3],
    :XATTACK6   => [:ATTACK, 6],
    :XDEFENSE   => [:DEFENSE, (Settings.pbGetGeneration >= 7) ? 2 : 1],
    :XDEFENSE2  => [:DEFENSE, 2],
    :XDEFENSE3  => [:DEFENSE, 3],
    :XDEFENSE6  => [:DEFENSE, 6],
    :XDEFEND    => [:DEFENSE, (Settings.pbGetGeneration >= 7) ? 2 : 1],
    :XDEFEND2   => [:DEFENSE, 2],
    :XDEFEND3   => [:DEFENSE, 3],
    :XDEFEND6   => [:DEFENSE, 6],
    :XSPATK     => [:SPECIAL_ATTACK, (Settings.pbGetGeneration >= 7) ? 2 : 1],
    :XSPATK2    => [:SPECIAL_ATTACK, 2],
    :XSPATK3    => [:SPECIAL_ATTACK, 3],
    :XSPATK6    => [:SPECIAL_ATTACK, 6],
    :XSPECIAL   => [:SPECIAL_ATTACK, (Settings.pbGetGeneration >= 7) ? 2 : 1],
    :XSPECIAL2  => [:SPECIAL_ATTACK, 2],
    :XSPECIAL3  => [:SPECIAL_ATTACK, 3],
    :XSPECIAL6  => [:SPECIAL_ATTACK, 6],
    :XSPDEF     => [:SPECIAL_DEFENSE, (Settings.pbGetGeneration >= 7) ? 2 : 1],
    :XSPDEF2    => [:SPECIAL_DEFENSE, 2],
    :XSPDEF3    => [:SPECIAL_DEFENSE, 3],
    :XSPDEF6    => [:SPECIAL_DEFENSE, 6],
    :XSPEED     => [:SPEED, (Settings.pbGetGeneration >= 7) ? 2 : 1],
    :XSPEED2    => [:SPEED, 2],
    :XSPEED3    => [:SPEED, 3],
    :XSPEED6    => [:SPEED, 6],
    :XACCURACY  => [:ACCURACY, (Settings.pbGetGeneration >= 7) ? 2 : 1],
