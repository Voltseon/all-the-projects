...
#    when :StrongWinds then pbDisplay(_INTL("The wind is strong."))
  ...
  def pbEndOfRoundPhase
    ...
    # Polarity Swap
    pbEORCountDownBattlerEffect(priority,PBEffects::PolaritySwap) { |battler|
      pbDisplay(_INTL("{1}'s polarity swapped back!",battler.pbThis))
    }
    # Perish Song
    perishSongUsers = []
    priority.each do |b|
    ...
    # Ignite
    pbEORCountDownFieldEffect(PBEffects::IgniteField,
      _INTL("The effects of Ignite have faded."))
    # Wonder Room
