...
#===============================================================================
# Badly poisons the target no accuracy override. (Toxic Plague)
#===============================================================================
class Battle::Move::BadPoisonTargetNoOverride < Battle::Move::PoisonTarget
  def initialize(battle, move)
    super
    @toxic = true
  end
...
#===============================================================================
# Causes the target to flinch. Effectiveness against Water-type is 2x. (Subzero Fang)
#===============================================================================
class Battle::Move::FlinchTargetSuperEffectiveAgainstWater < Battle::Move::FlinchTarget
  def pbCalcTypeModSingle(moveType, defType, user, target)
    return Effectiveness::SUPER_EFFECTIVE_ONE if defType == :WATER
    return super
  end
...
# (Fake Out)
#===============================================================================
class Battle::Move::DamageBasedOnTurns < Battle::Move
  def pbBaseDamage(baseDmg, user, target)
    return [baseDmg * (user.turnCount+1), 150].min
  end
end
