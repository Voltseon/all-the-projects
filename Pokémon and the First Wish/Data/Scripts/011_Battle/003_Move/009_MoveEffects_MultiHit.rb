...
# Eruptic Meteors
#===============================================================================
class Battle::Move::ErupticMeteors < Battle::Move::HitTwoToFiveTimes
end

#===============================================================================
# Hits 2-3 times. (Air Bubble)
#===============================================================================
class Battle::Move::HitTwoToThreeTimes < Battle::Move
  def multiHitMove?; return true; end
...
#===============================================================================
# Chance to paralyze the target. Deals more damage when with an ally
# (Snuggle Zap)
#===============================================================================
class Battle::Move::SnuggleZap < Battle::Move::ParalyzeTarget
  def pbBaseDamage(baseDmg, user, target)
    baseDmg *= 2 if !user.allAllies.empty?
    return baseDmg
  end
end

#===============================================================================
# Chance to flinch the target. Deals more damage when with an ally
# (Zapping Snuggle)
#===============================================================================
class Battle::Move::ZappingSnuggle < Battle::Move::FlinchTarget
  def pbBaseDamage(baseDmg, user, target)
    baseDmg *= 2 if !user.allAllies.empty?
    return baseDmg
  end
...
#===============================================================================
# Deals damage based on the amount of party members. Deals more damage when with an ally
# (Swarming Bites)
#===============================================================================
class Battle::Move::SwarmingBites < Battle::Move::HitOncePerUserTeamMember
  def pbBaseDamage(baseDmg, user, target)
    i = @beatUpList.shift   # First element in array, and removes it from array
    atk = @battle.pbParty(user.index)[i].baseStats[:ATTACK]
    return 15 + (atk / 10) * (user.allAllies.empty? ? 1 : 1.5)
  end
end
