...
# Effectiveness against Grass-type is 4x (Decompose)
#===============================================================================
class Battle::Move::DisableTargetHealingMovesStrongAgainstGrass < Battle::Move::DisableTargetHealingMoves 
  def pbCalcTypeModSingle(moveType, defType, user, target)
    return 8 if defType == :GRASS
    return super
  end
end
