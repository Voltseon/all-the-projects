class Battle::AI
  ...
  def pbGetMoveScoreFunctionCode(score, move, user, target, skill = 100)
    ...
    #---------------------------------------------------------------------------
    when "HitTwoToFiveTimes", "HitTwoToThreeTimes", "ErupticMeteors"
    #---------------------------------------------------------------------------
    ...
    when "PowerUpAllyMove"
      ...
      score -= 90 if !hasAlly
    #---------------------------------------------------------------------------
    when "CounterPhysicalDamage","GuardianOfSteel"
    ...
    when "SwitchOutTargetStatusMove"
      ...
      if score > 20
        ...
        score += 50 if target.pbOwnSide.effects[PBEffects::DrowsyMist] > 0
    ...
    when "SwitchOutTargetDamagingMove"
      if !target.effects[PBEffects::Ingrain] &&
        ...
        score += 40 if target.pbOwnSide.effects[PBEffects::DrowsyMist] > 0
