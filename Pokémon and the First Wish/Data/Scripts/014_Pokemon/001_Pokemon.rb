...
class Pokemon
  ...
  # @return {Symbol => Integer} this is a hash representing how many times each move is used
  attr_accessor :move_usages
  # @return [Integer] this is how much damage in total it has dealt
  attr_accessor :damage_dealt
  # @return [Integer] this is how much damage in total it has taken
  attr_accessor :damage_taken
  # @return [Integer] this is how many times it has defeated an opponent
  attr_accessor :kill_count
  # @return [Integer] this is how many times it has fainted
  ...
  def move_usages
    @move_usages = {} if @move_usages.nil?
    return @move_usages
  end

  def damage_dealt
    @damage_dealt = 0 if @damage_dealt.nil?
    return @damage_dealt
  end
  ...
  def kill_count
    @kill_count = 0 if @kill_count.nil?
    return @kill_count
  end

  def faint_count
    @faint_count = 0 if @faint_count.nil?
    return @faint_count
  end
