...
class PokemonSystem
  ...
  def initialize
    ...
    @autosave       = 1     # Autosave (0=off, 1=on)
  end
end
  ...
  def pbOptions
    pbActivateWindow(@sprites, "option") {
      ...
      loop do
        ...
        Input.update
        pbUpdate
        #echoln Input::scroll_v unless Input::scroll_v == 0
...
MenuHandlers.add(:options_menu, :autosaving, {
  "name"        => _INTL("Autosave"),
  "order"       => 130,
  "type"        => EnumOption,
  "parameters"  => [_INTL("Off"), _INTL("On")],
  "description" => _INTL("Whether the game should autosave."),
