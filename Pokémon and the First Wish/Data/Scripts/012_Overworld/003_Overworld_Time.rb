...
module PBDayNight
  HOURLY_TONES = [
    Tone.new(-50, -50, -5,  30),   # Night           # Midnight *
    Tone.new(-50, -50, -5,  30),   # Night           # 1AM
    Tone.new(-50, -50, -5,  30),   # Night           # 2AM
    Tone.new(-50, -50, -5,  25),   # Night           # 3AM
    Tone.new(-35, -35, 15,  20),   # Night           # 4AM
    Tone.new(-25, -25,  5,  15),   # Day/morning     # 5AM
    Tone.new(-25, -25,  5,  10),   # Day/morning     # 6AM *
    Tone.new(-25, -25,  5,  5),   # Day/morning     # 7AM
    Tone.new( -5,  -5,  0,  5),   # Day/morning     # 8AM
    Tone.new( -5,  -5,  0,  0),   # Day/morning     # 9AM
    Tone.new( -5,  -5,  0,  0),   # Day             # 10AM
    Tone.new( -5,  -5,  0,  0),   # Day             # 11AM
    Tone.new(  0,   0,  0,  0),   # Day             # Noon *
    Tone.new(  0,   0,  0,  0),   # Day             # 1PM
    Tone.new(  0,   0,  0,  0),   # Day/afternoon   # 2PM
    Tone.new(  0,   0,  0,  0),   # Day/afternoon   # 3PM
    Tone.new(  0,  -5,  -5, 0),   # Day/afternoon   # 4PM
    Tone.new(  5, -10,-30,  5),   # Day/afternoon   # 5PM
    Tone.new( 10, -35,-35,  5),   # Day/evening     # 6PM *
    Tone.new(-30, -30,  0,  10),   # Day/evening     # 7PM
    Tone.new(-50, -50, -5,  15),   # Day/evening     # 8PM
    Tone.new(-50, -50, -5,  20),   # Night           # 9PM
    Tone.new(-50, -50, -5,  20),   # Night           # 10PM
    Tone.new(-50, -50, -5,  25)    # Night           # 11PM
  ]
  @cachedTone = nil
