...
# Grass rustle sound
#===============================================================================
EventHandlers.add(:on_player_step_taken, :grass_rustling,
  proc {
    next if !$scene.is_a?(Scene_Map)
    next if !$map_factory.getTerrainTagFromCoords($game_map.map_id, $game_player.x, $game_player.y, true).shows_grass_rustle
    pbSEPlay("Grass", 80, rand(90..110))
  }
)
