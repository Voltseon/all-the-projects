...
class Scene_Map
  ...
  def createSpritesets
    ...
    @active_hud.hide(1) if $game_map.map_id == 1 || ([81,93].include?($game_map.map_id) && !$game_switches[60])
=begin
    Discord.update_activity({
      :large_image => "icon_big",
      :large_image_text => "Pokémon and the First Wish",
      :details => "", # TODO: Add details
      :state => "Exploring Peskan",
